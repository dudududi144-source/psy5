...
export type DrumType = 'kick' | 'snare' | 'clap' | 'hatC' | 'hatO' | 'tom' | 'rim' | 'glitch' | 'shaker' | 'conga' | 'bongo' | 'cowbell' | 'clave' | 'zap' | 'boom' | 'riser' | 'impact' | 'downlifter' | 'darbuka' | 'tambourine' | 'triangle' | 'crash' | 'revcym' | 'agogo' | 'timbale';
