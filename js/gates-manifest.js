...
/* 52 ids — v0.29.0 added G53 (kick dims) + G54 (pad spread) + G55 (form
   library), the psyreason re-review #2 ports. Earlier: v0.26.0 added G52
   (reason liveness, v0.23.0): it was registered in js/ui/tests.js but
   silently missing from the hand-typed e2e list — the roast's own #9
   found its live specimen three releases in. */
