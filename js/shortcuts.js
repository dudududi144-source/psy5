...
export const SHORTCUTS = [
  ...
  { key: 'y', label: 'Pad 9 (live trigger — second pad row, v0.22.0)', group: 'Performance' },
  { key: 'u', label: 'Pad 10 (live trigger — second pad row, v0.22.0)', group: 'Performance' },
  { key: 'i', label: 'Pad 11 (live trigger — second pad row, v0.22.0)', group: 'Performance' },
  { key: 'o', label: 'Pad 12 (live trigger — second pad row, v0.22.0)', group: 'Performance' },
  { key: 'p', label: 'Pad 13 (live trigger — second pad row, v0.22.0)', group: 'Performance' },
  { key: 'j', label: 'Pad 14 (live trigger — second pad row, v0.22.0)', group: 'Performance' },
  { key: 'k', label: 'Pad 15 (live trigger — second pad row, v0.22.0)', group: 'Performance' },
  { key: 'l', label: 'Pad 16 (live trigger — second pad row, v0.22.0)', group: 'Performance' },
  ...
  { key: 'f', label: 'Fill (drums — press again cycles the 8 layouts: CLASSIC/ROLL/TOMLINE/SNARE16/CLIMB/STUTTER/HOVER/SPIRAL)', group: 'Performance' },
  ...
  { key: 'd', label: 'DJ tool — downlifter (falling sweep)', group: 'Performance' },
  { key: 'g', label: 'ECHO THROW — delay-feedback slam, auto-releases after 2 bars (press again = release now)', group: 'Performance' },
  { key: 'h', label: 'MUFFLE — master EQ veil, auto-releases after 2 bars (press again = release now)', group: 'Performance' },
